...
<head>
  ...
  <title>Chef's Food - Authentic Pakistani Cuisine</title>
...
<div class="hero text-white text-center">
  <div class="container">
    <h1 class="display-3 fw-bold mb-4">Authentic Pakistani Flavors</h1>
    <p class="lead mb-4">Experience the taste of home with our traditional recipes</p>
    <a href="menu.php" class="btn btn-primary btn-lg">Explore Menu</a>
  </div>
</div>

<div class="container mt-5">
  <h2 class="text-center mb-5 fw-bold" style="color: #ff6b35;">Today's Chef Specials 🔥</h2>
  <div class="row g-4">
    <?php
    $result = mysqli_query($conn, "SELECT * FROM menu WHERE is_special=1 LIMIT 3");
...
<footer class="bg-dark text-white text-center py-4 mt-5">
  <p class="mb-0">© 2026 Chef's Food. All Rights Reserved | Made with ❤️</p>
</footer>
